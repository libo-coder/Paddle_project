...
def main():
    # print(FLAGS.config)     # ./configs/faster_rcnn_r50_1x.yml
    ...
    for iter_id, data in enumerate(loader()):
        ...
        for im_id in im_ids:
            ...
            if FLAGS.use_vdl:
                ...
                vdl_writer.add_image("original/frame_{}".format(vdl_image_frame),
                                     original_image_np,
                                     vdl_image_step)
