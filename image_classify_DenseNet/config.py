...
train_parameters = {  
    ...
    "label_dict": {},  
    "data_dir": "E:/project/dataset/image_classify_DenseNet",  # 训练数据存储地址
    ...
    "dropout_prob": 0.2,
    "dropout_seed": None,
    "infer_img": 'E:/project/dataset/image_classify_DenseNet/sunflowers/3840761441_7c648abf4d_n.jpg',   # 预测图片
